  ...
  return (
    <div className="h-full flex flex-col">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            {isMobile && (
              <button
                ...
                className="p-2.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 touch-manipulation active:scale-95 pwa-menu-button flex-shrink-0"
              >
          ...
          <div className="flex-shrink-0 hidden sm:block">
            <div className="relative flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
              ...
              <Tooltip content="Terminal" position="bottom">
                <button
                  onClick={() => setActiveTab('plainshell')}
                  className={`relative px-2 sm:px-3 py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all duration-200 ${
                    activeTab === 'plainshell'
                      ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm'
                      : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700'
                  }`}
                >
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className={`h-full overflow-hidden ${activeTab === 'plainshell' ? 'block' : 'hidden'}`}>
          <StandaloneShell
            project={selectedProject}
            session={null}
            isActive={activeTab === 'plainshell'}
            showHeader={false}
            isPlainShell={true}
            command="bash"
          />
